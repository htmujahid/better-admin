...
import { uploadAccountImage } from '../_lib/actions/upload-account-image'
import { deleteAccountImage } from '../_lib/actions/delete-account-image'
    ...
    (file: File | null) => {
      ...
      if (file) {
        const promise = async () => {
          ...
          const imageUrl = await uploadAccountImage(formData)
